      ...
      <div class="col-md-12">
        <div class="well well-sm">
          <form class="form-horizontal" method="post">
            <fieldset>
              <legend class="text-center header">Proveedores</legend>
              <form>
                <div class="form-row">

                    <div class="form-group col-md-6">
                         <label for="inputEmail4">Buscar</label>
                         <input type="Buscar" class="form-control" id="inputEmail4" placeholder="Buscar">
                    </div>
                  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="Vendedor de contacto" class="form-control" id="inputPassword4" placeholder="">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputEmail4">Dirección</label>
                    <input type="Dirección" class="form-control" id="inputEmail4" placeholder="">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputEmail4">Numero Telefonico</label>
                    <input type="Numero Telefonico" class="form-control" id="inputEmail4" placeholder="">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputEmail4">Correo Electronico</label>
                    <input type="Correo Electronico" class="form-control" id="inputEmail4" placeholder="">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputEmail4">Forma de Despacho</label>
                    <input type="Forma de Despacho" class="form-control" id="inputEmail4" placeholder="">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputEmail4">Pagina Web</label>
                    <input type="Pagina Web" class="form-control" id="inputEmail4" placeholder="">
                  </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="Rut" class="form-control" id="inputEmail4" placeholder="">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputPassword4">Nombre Completo </label>
                    <input type="Nombre Completo" class="form-control" id="inputPassword4" placeholder="">
                  </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="Numero de Cuenta" class="form-control" id="inputEmail4" placeholder="">
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 p-4">
                    <button class="btn btn-outline-success my-2 my-sm-0"><a href=""
                        type="">Guardar</a></button>
                    <button class="btn btn-outline-success my-2 my-sm-0"><a href=""
                        type="">Actualizar</a></button>
                    <button class="btn btn-outline-success my-2 my-sm-0"><a href=""
                        type="">Eliminar</a></button>
                  </div>
                  <div class="col-md-4"></div>
                </div>
              </form>
